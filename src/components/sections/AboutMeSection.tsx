...
const titleParentVariants: Variants = {
  hidden: {},
  visible: { transition: { type: "tween", staggerChildren: 0.1, delayChildren: 0.1, duration: 0.5 } },
};

const titleChildVariants: Variants = {
  hidden: { opacity: 0, y: 20, scale: 0.98 },
  visible: { opacity: 1, y: 0, scale: 1, transition: { type: "tween", duration: 0.6 } },
};
            ...
            <div className="space-y-8 relative pl-6 before:absolute before:inset-y-0 before:w-1 before:bg-primary/30 before:left-0 before:rounded-full">
              {experiences.map((exp, index) => (
                <motion.div
                  ...
                  viewport={{ once: true, amount: 0.2 }}
                  transition={{ type: "tween", duration: 0.5, delay: index * 0.15 }}
                >
