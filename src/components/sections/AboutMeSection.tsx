...
const titleParentVariants: Variants = {
  hidden: {},
  visible: { transition: { type: "tween", staggerChildren: 0.1, delayChildren: 0.1, ease: cinematicEasingString, duration: 0.5 } },
};
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
            ...
            <div className="space-y-8 relative pl-6 before:absolute before:inset-y-0 before:w-1 before:bg-primary/30 before:left-0 before:rounded-full">
              {experiences.map((exp, index) => (
                <motion.div
                  ...
                  viewport={{ once: true, amount: 0.2 }}
                  transition={{ type: "tween", duration: 0.5, delay: index * 0.15, ease: cinematicEasingString }}
                >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.2 }}
            transition={{ type: "tween", duration: 0.7, ease: cinematicEasingString, delay: 0.3 }}
          >
         ...
         <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.3 }}
            transition={{ type: "tween", duration: 0.7, ease: cinematicEasingString, delay: 0.4 }}
          >
